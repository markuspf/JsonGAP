...
PackageName := "JsonGAP",
Subtitle := "Printing GAP objects to JSON (written in GAP)",
Version := "0.1",
...
#SupportEmail   := "TODO",
PackageWWWHome  := "https://markuspf.github.io/JsonGAP/",
...
PackageDoc := rec(
  ...
  LongTitle := "Printing GAP objects to JSON (written in GAP)",
),
